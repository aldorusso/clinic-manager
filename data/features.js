...
export const features = [
  {
    ...
    imgAlt: "CRM de Ventas",
    title: "CRM de Ventas",
    description:
      "Pipeline visual avanzado. Controla en qué etapa se encuentra cada interesado: ¿Nuevo, Contactado, Cita Agendada o No-Show?",
  },
  {
    id: 2,
    imgSrc: "/assets/images/template/feature-02.svg",
    imgAlt: "Agenda Médica",
    title: "Agenda Médica",
    description:
      "Calendario avanzado para gestión de citas con asignación inteligente por médico o especialidad.",
  },
  {
    id: 3,
    imgSrc: "/assets/images/template/feature-03.svg",
    imgAlt: "Portal del Paciente",
    title: "Portal del Paciente",
    description:
      "Espacio dedicado donde cada paciente puede visualizar su historial de tratamientos, sesiones y firmar consentimientos.",
  },
];
...
export const features2 = [
  {
    ...
    title: "Dueño",
    description:
      "Acceso total al sistema. Visión global del negocio.",
  ...
  {
    icon: "unicon-thermometer",
    title: "Médico",
    description:
      "Historial clínico y agenda médica.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
  {
    icon: "unicon-money",
  ...
  },
  {
    ...
    title: "Paciente",
    description:
      "Portal personal y consentimientos.",
    backgroundColor: "bg-white dark:bg-gray-800",
  },
];
...
export const features6 = [
  {
    id: 1,
    imgSrc: "/assets/images/template/feature-01.svg",
    imgAlt: "CRM Especializado",
    title: "CRM Especializado en Estética",
    description:
      "Gestiona tus leads desde la captación hasta el cierre. Visualiza el pipeline de ventas y nunca pierdas una oportunidad de conversión.",
    link: null,
  },
  {
    id: 2,
    imgSrc: "/assets/images/template/feature-02.svg",
    imgAlt: "Automatización Inteligente",
    title: "Automatización Inteligente",
    description:
      "Recordatorios de citas automáticos por WhatsApp y Email para reducir el ausentismo y recuperar pacientes inactivos.",
    link: { text: "Ver integraciones", href: "#" },
  },
  {
    id: 3,
    imgSrc: "/assets/images/template/feature-03.svg",
    imgAlt: "Seguridad y Cumplimiento",
    title: "Seguridad y Cumplimiento",
    description:
      "Tus datos y los de tus pacientes están seguros con encriptación avanzada y cumplimiento de normativas de privacidad de datos.",
    link: null,
  },
  {
    id: 4,
    imgSrc: "/assets/images/template/feature-04.svg",
    imgAlt: "Reseñas y Reputación",
    title: "Gestión de Reputación",
    description:
      "Solicita reseñas automáticamente a pacientes satisfechos y mejora tu posicionamiento en Google Maps.",
    link: null,
  },
];
...
export const features8 = [
  {
    ...
    title: "Integraciones perfectas con tus herramientas existentes",
  },
  {
    imgSrc: "/assets/images/features/home-8-feature-05.png",
    title: "Panel intuitivo para una visión global inmediata",
  },
  {
    imgSrc: "/assets/images/features/home-8-feature-06.png",
    title: "Análisis de datos y reportes automatizados",
  },
];
...
export const features9 = [
  ...
  },
  {
    ...
    title: "Descubre datos en todas partes",
  },
  {
    order: "order-2 sm:order-1 lg:order-0",
    icon: "/assets/images/custom-icons/home-8-icon-03.svg",
    title: "Enriquece datos con contexto",
  },
  {
    order: "order-1 lg:order-0",
