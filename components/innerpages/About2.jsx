      ...
      <div className="section-outer panel py-6 xl:py-9 bg-secondary dark:bg-gray-800">
        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            ...
            >
              <h2 className="h3 lg:h2 mb-4">Cómo ayuda ClinicManager</h2>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                Los equipos utilizan ClinicManager para mejorar los flujos de trabajo, obtener insights valiosos y
                acelerar procesos, todo mientras brindan una experiencia increíble a sus pacientes.
                Las clínicas confían en nuestro software todo-en-uno para automatizar la gestión,
                citas, seguimientos y más.
              </p>
              <p className="fs-5 xl:fs-4 text-dark dark:text-white text-opacity-70">
                Con potentes capacidades de creación de documentos y flujos de trabajo, los equipos pueden
                ofrecer a sus pacientes una experiencia más profesional, oportuna y atractiva,
                construyendo relaciones duraderas que impulsan el crecimiento del negocio.
              </p>
