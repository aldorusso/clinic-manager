          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <p className="fs-6 xl:fs-5 xl:px-8">
                Ofrece una plataforma unificada que fomenta la innovación y la gestión de datos de principio a fin.
              </p>
            </div>
            <div
                    ...
                    <div className="panel">
                      <div className="vstack gap-1">
                        ...
                        <p className="desc fs-6 opacity-60 dark:opacity-90">
                          Ya sea que tengas un equipo de 2 o 200, nuestras bandejas
                          de entrada compartidas mantienen a todos en la misma página.
                        </p>
                      </div>
                    </div>
                  </div>
