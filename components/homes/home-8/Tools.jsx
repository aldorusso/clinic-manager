        ...
        <div className="container">
          <div className="section-inner panel max-w-lg mx-auto">
            ...
            >
              ...
              <h2 className="h3 lg:h2 m-0">Obtén más valor de tus herramientas</h2>
              <p className="fs-6 xl:fs-5 xl:px-8">
                Conecta tus herramientas, conecta a tus equipos. Con más de 200 aplicaciones disponibles.
              </p>
            </div>
            <div
