          ...
          <div className="container max-w-lg">
            ...
            <div className="post-footer panel vstack sm:hstack gap-3 justify-between justifybetween border-top py-4 mt-4 xl:py-9 xl:mt-9">
              <ul className="nav-x gap-narrow text-primary">
                ...
                <li>
                  <Link href={`/blog-category/${blogItem.category}`}>
                    {blogItem.category}
                  </Link>
                </li>
              </ul>
              <ul className="post-share-icons nav-x gap-narrow">
                <li className="me-1">
                  <span className="text-black dark:text-white">Compartir:</span>
                </li>
                <li>
                  <a
              ...
              <div className="row g-4 items-center">
                ...
                <div className="col">
                  <div className="panel vstack items-start gap-2 md:gap-3">
                    <h4 className="h5 m-0">{blogItem.author}</h4>
                    <p className="fs-6">
                      Especialista en Marketing Digital para clínicas estéticas. Ayudo a convertir leads en pacientes leales mediante estrategias de CRM y automatización.
                    </p>
            ...
            <div className="post-navigation panel vstack sm:hstack justify-between gap-2 mt-8 xl:mt-9 fdr-min-600">
              <div className="new-post panel hstack w-100 sm:w-1/2">
                ...
                <div className="panel vstack justify-center px-2 gap-1 w-1/3">
                  <span className="fs-7 opacity-60">Artículo Anterior</span>
              ...
              <div className="new-post panel hstack w-100 sm:w-1/2">
                <div className="panel vstack justify-center px-2 gap-1 w-1/3 text-end rtl:text-start">
                  <span className="fs-7 opacity-60">Siguiente Artículo</span>
                  <h6 className="h6 lg:h5 m-0">
                    Ver más artículos
                  </h6>
                </div>
            ...
            <div className="post-related panel border-top pt-2 mt-8 xl:mt-9">
              <h4 className="h5 xl:h4 mb-5 xl:mb-6">Artículos relacionados:</h4>
